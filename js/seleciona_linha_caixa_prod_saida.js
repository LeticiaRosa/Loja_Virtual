...
$(window).on("click", (function() {
    ...
    **/
    ...
    btnVisualizar.addEventListener("click", function() {
        ...
        document.getElementById('produto-saida').value = selecionado[1].innerHTML;
        document.getElementById('nome-saida').value = parseFloat(selecionado[8].innerHTML);
        document.getElementById('Quantidade-saida').focus();

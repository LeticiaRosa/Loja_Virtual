function busca_produto(teste) {
    ...
    tipo_mov = document.getElementById("tipo").value;
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            document.getElementById("itens_entrada").value = qtd_pro;
...
function excluirlinha(id) {
    ...
    itens = document.getElementById("itens_entrada").value;
    total_itens = itens - 1;
    document.getElementById("itens_entrada").value = total_itens;

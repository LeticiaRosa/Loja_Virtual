...
$query_2 = "INSERT INTO CAIXA (ID_EMPRESA, NOME,NOME_MAQUINA,STATUS,OBSERVACAO,id_usuario,data_cadastro,ID_USUARIO_ALT,DATA_ALTEROU) values ('{$empresa['id_empresa']}', '$nome_caixa', '$maquina', '$status' ,'$observacao','$id_usuario', now(),'$id_usuario',now())";

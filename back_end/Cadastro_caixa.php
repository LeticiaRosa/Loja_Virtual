...
$query_4 = "select count(1) as contagem from caixa where nome_maquina ='$maquina'";
$contagem = mysqli_query($conexao, $query_4);
$variavel_3 = mysqli_fetch_assoc($contagem);
$existe_maquina = $variavel_3['contagem'];

if($existe_maquina > 0){
    $_SESSION['erro_cadastro'] = "Para essa máquina já existe um caixa cadastrado!";
